      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between">
          <div className="flex space-x-4">
            ...
            <Link href="/LoginPage"  className="text-white hover:text-gray-300 transition duration-300 ease-in-out">
              Login
            </Link>
            <Link href="/SignupPage"  className="text-white hover:text-gray-300 transition duration-300 ease-in-out">
              Signup
            </Link>
            <Link href="/AboutusPage"  className="text-white hover:text-gray-300 transition duration-300 ease-in-out">
              Aboutus
            </Link>
          </div>
